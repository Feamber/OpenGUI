...
def gen_text():
    ...
    add_longhand("text-decoration-thickness", "float", "1", "Number", restyle_damage="TextLayout")
    add_longhand("text-justify", "ETextJustify", "ETextJustify::InterWord", "TextJustify", restyle_damage="TextLayout")
    struct.headers.append("yoga/Yoga.h")
