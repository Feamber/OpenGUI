...
namespace OGUI
{
    ...
    struct StyleDesc
    {
		...
		RestyleDamage (*ApplyTransitionProperties)(ComputedStyle& style, const ComputedStyle& src, const ComputedStyle& dst, const gsl::span<TransitionProperty>& props);
	...
	struct ComputedStyle
	{
		...
		RestyleDamage ApplyTransitionProperties(const ComputedStyle& src, const ComputedStyle& dst, const gsl::span<TransitionProperty>& props);
