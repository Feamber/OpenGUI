...
namespace OGUI
{
    ...
    OGUI_API bool TryGet(const OGUI::KeyAnalogInputEvent& event, ostr::string_view name, OGUI::Meta::ValueRef& out);
    OGUI_API bool TryGet(const OGUI::KeyDownNavigationPostEvent& event, ostr::string_view name, OGUI::Meta::ValueRef& out);
