...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_RuleSet = 27,                   /* RuleSet  */
  YYSYMBOL_SelectorList = 28,              /* SelectorList  */
  YYSYMBOL_ComplexSelector = 29,           /* ComplexSelector  */
  YYSYMBOL_Selector = 30,                  /* Selector  */
  YYSYMBOL_SelectorPart = 31,              /* SelectorPart  */
  YYSYMBOL_RuleSetItem = 32,               /* RuleSetItem  */
  YYSYMBOL_RuleSetContent = 33,            /* RuleSetContent  */
  YYSYMBOL_Value = 34,                     /* Value  */
  YYSYMBOL_SizeList = 35                   /* SizeList  */
};
...
#line 79 "css.y"
    {
        complexSelector.priority = (yylsp[0]).first_line;
...
#line 86 "css.y"
    {
        complexSelector.priority = (yylsp[-2]).first_line;
        std::reverse(complexSelector.selectors.begin(), complexSelector.selectors.end());
        styleSheet.styleSelectors.push_back(std::move(complexSelector));
        reset(complexSelector);
    }
...
#line 153 "css.y"
    {
        ...
        if(!OGUI::ParseProperty(styleSheet.storage, (yyvsp[-2].text), value, styleRule, errorMsg, errorType))
        {
            yyerror(errorType == OGUI::ParseErrorType::InvalidProperty? &(yylsp[-2]):&(yylsp[0]), scanner, errorMsg);
            YYABORT;
        }
