...
bool OGUI::StyleEffects::ParseProperties(StyleSheetStorage& sheet, std::string_view prop, std::string_view value, StyleRule& rule, std::string& errorMsg)
{
    ...
    switch(phash)
    {
        case Ids::opacity:{
            ...
            {
                errorMsg = "failed to parse opacity value!";
                return false;
            }
            return true;
        }
